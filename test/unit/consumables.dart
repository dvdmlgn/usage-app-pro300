...
void main() {
  group('Consumables functionality:', () {
    ...
    test('an existing consumable has been successfully edited', () {
      ...
      var indexOfInitial =
          consumablesDummy.indexWhere((e) => e.id == _initalConsumableState.id);

      Consumables.edit(indexOfInitial, _editedConsumableState);

      var indexOfEdited =
          consumablesDummy.indexWhere((e) => e.id == _editedConsumableState.id);
    ...
    test('an existing consumalbe has been successfully deleted', () {
      ...
      final _endIndex =
          consumablesDummy.indexWhere((e) => e.id == _consumable.id);
    ...
    test('an existing consumalbe has been successfully consumed', () {
      ...
      Consumables.add(_consumable);
      Consumables.consumed(_consumable.id);
      final _endIndex =
          consumablesDummy.indexWhere((e) => e.id == _consumable.id);
    ...
    test('an existing consumalbe has been successfully wasted', () {
      ...
      Consumables.add(_consumable);
      Consumables.wasted(_consumable.id);
      final _endIndex =
          consumablesDummy.indexWhere((e) => e.id == _consumable.id);
    ...
    test('a consumable has been added to the shopping list', () {
      ...
      final _shoppingListIndex =
          groceries.indexWhere((e) => e.productId == _consumable.productId);
